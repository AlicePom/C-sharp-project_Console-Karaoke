...
{
    public class ConsoleSongPlayer : ISongPlayer
    {
        ...
        public void PlaySong(string songName, Dictionary<string, List<object>> songs)
        {
            List<TableRow> chosenSong = songs[songName].Cast<TableRow>().ToList(); ;
